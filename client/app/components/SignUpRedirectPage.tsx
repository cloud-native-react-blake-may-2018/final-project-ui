...
export class SignUpRedirectPage extends Component {
  // @ts-ignore
  componentDidMount = () => {
    ...
    let redirectUrl =
      process.env.NODE_ENV === 'production'
        ? `https://quizard.auth.us-east-2.amazoncognito.com/signup?response_type=code&client_id=1q83lmu6khfnc0v8jjdrde9291&redirect_uri=${
            environment.context
          }/redirect`
        : `https://quizard.auth.us-east-2.amazoncognito.com/signup?response_type=code&client_id=1q83lmu6khfnc0v8jjdrde9291&redirect_uri=${
            environment.context
